		...
		<div class="media">
			...
			<div class="media-body media-bottom">
				<div class="fs_12 color_gray">
                    ...
                    Доставка заказов осуществляется бесплатно при сумме заказа от 10000 рублей.
                    Сумма доставки фиксированная для жителей <nobr>г. Москва – 450 р.,</nobr> <nobr>г. Кемерово,</nobr> <nobr>г. Томск,</nobr> <nobr>г. Новосибирск – 350 р.,</nobr>
                    в другие регионы рассчитывается с менеджером Fi’ora. Сумма доставки оплачивается курьеру при получении заказа. Платная доставка в города России
                    осуществляется транспортными компаниями по выгодной цене за счет выбора ближайшего пункта отгрузки Fi’ora к Вам. Логистический центр Fi’ora
                    определяет ближайший пункт отгрузки в зависимости от вашего населённого пункта (более 30 мест отгрузки по России).
                    <a href="https://myfiora.com/pay_and_delivery.php">Подробнее условия доставки и оплаты</a>
		...
		<div class="m-b-5">
			<div class="pull-left">
				...
				<ul class="m-b-0 list-inline list-inline-top" id='promo_div'>
					<li id='promo_error'>
                        ...
                        <div id='promo_match_error' class="help-block text-center" style='display:none; font-size: 80%;'></div>
					</li>
			...
			<div class="pull-right basketpad">
				<ul class="m-b-0 list-unstyled text-right">
                    <li class="color_gray">Сумма за товар: <span id='products_summa' data-summa="">0</span></li>
                    <li id="discount_field" class="color_red" style="display: none">Сумма скидки: <span id='products_discount'>0</span></li>
                    <li class="color_gray">Сумма доставки:
                        ...
                        $main_city_ids = array(1503901, 1489425, 1496747, 524901);
