			...
			<div class="col-xs-12 col-sm-6">
				<div class="fs_18">
					...
					<font color="grey" style="font-size: 15px;">
						(Зарезервировано до <?= date('H:i d.m.Y', strtotime($time)) ?>)
					</font>
					<? endif; ?>
		...
		<div class="m-b-5">
			<div class="pull-left">
				...
				<ul class="m-b-0 list-inline list-inline-top" id='promo_div'>
					...
					<li><button id='promo_code_button' onclick="get_promo();" type="submit" class="btn btn-default"><i class="fa fa-angle-right"></i></button></li>
				</ul>
			</div>
			<div class="pull-right">
				<ul class="m-b-0 list-unstyled text-right">
					<li class="color_gray">Сумма за товар: <span id='products_summa'>0</span></li>
					<li class="color_gray">Сумма доставки по расчету ТК<!-- <span id='delivery_summa'>0</span></li> -->
					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							...
							<div class="m-b-2 inpbox">
								<input id='name_1' onblur="check_input();" class="form-control" type="text" value="" placeholder="Имя Фамилия 1" />
				...
				<div class="inset-box">
					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							...
							<div class="m-b-2 inpbox">
								<input id='name_2' onblur="check_input();" class="form-control" type="text" value="" placeholder="Имя Фамилия 2" />
								<span class="required">*</span>
							</div>
							<div class="m-b-2 inpbox">
...
//geo_city_id		
		...
		if ($geo_city_id='1503901') { $pay_nal=1; }
		if ($geo_city_id='1489425') { $pay_nal=1; }
		if ($geo_city_id='1496747') { $pay_nal=1; }
		if ($geo_city_id='524901') { $pay_nal=1; }
		if ($geo_city_id='1486209') { $pay_nal=1; }

		if ($pay_nal==1) {
			echo "
				<div class='m-b-1' id='pay_type' data-pay_type='2'>
					<div class='radio'>
						<label><input id='pay_type_1' type='radio' name='pay' value='1' /> Оплата курьеру наличными</label>
					</div>
				</div>
				<div class='m-b-1'>
					<div class='radio'>
						<label><input id='pay_type_2' type='radio' name='pay' value='2' checked/> Онлайн оплата</label>
					</div>
				</div>
			";
		} else {
...
?>
		...
		<div class="m-b-2">
			<div class="checkbox">
				<label><input id='agree' type="checkbox" name="agree" value="1" checked /> Я ознакомлен и согласен с <a href="#">условиями оферты</a></label>
			</div>
		</div>
