...
?>
	...
	<div class="container">
		...
		<div class="text-center color_black">
			<div class="m-b-3 fs_24">Ваш заказ № <? echo $order[0]+171300; ?></div>
			<div class="m-b-3">Спасибо за оформление заказа в интернет-магазине Myfiora.com </div>
