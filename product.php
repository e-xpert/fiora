...
//                    else { echo "<li><span class='color_gray'>нет в наличии</span></li>"; }
	...
	<div class="product_advantage">
		...
		<div class="body" style="display: block !important;">
			<div class="container">
				<div class="row row_50">
					<div class="col-sm-6">
						<div class="icon ico_24">
							...
							При заказе с сайта myfiora.com, вы гарантированно получаете подлинную
							композициию Фиора, так как мы являемся <a href="contacts.php">официальными представителями
					...
					<div class="col-sm-6">
						<div class="icon ico_24">
							<div class="ico top"><img src="images/tick24.png" alt="" /></div>
							<div class="title">Комфортный заказ с гарантией Fi`ora</div>
                            Программа доступна на сайте официального представительства ТМ Fi’ora и
                            действует на территории города Москва при покупке композиции от 3 500 рублей
                            (доступно на просмотр до трёх композиций). Доставка и возврат осуществляются бесплатно.
						</div>
					</div>
				</div>
				<div class="m-b-3"></div>
				<div class="row row_50">
					...
					<div class="col-sm-6">
						<div class="icon ico_24">
							<div class="ico top"><img src="images/tick24.png" alt="" /></div>
							<div class="title">Предложение актуальной ассортиментной линейки </div>
                            На нашем сайте Вы всегда найдете актуальный ассортимент продукции под торговой маркой Fi’ora,
                            в том числе по сопутствующей продукции. Более того, каждая композиция отправляется
                            с полным комплектом фирменной атрибутики согласно политики бренда.
						</div>
					</div>
				</div>
			</div>
