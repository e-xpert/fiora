							...
							<span class="tooltips bottom right">
								...
								<div class="tooltips_box">
									...
									<div class="tooltips_box_body fs_12">
										...
										можете по единому контактному телефону 8-800-550-83-99.<br />
									</div>
								</div>
							</span>
						</li>
...
<!--										<dd><a href="trands.php">Тренды 2017</a></dd>-->
                                        ...
                                        <dd>
                                            <a id="modal_hook_open" href="javascript:void(0)" data-toggle="modal" data-target="#modal_hook" rel="nofollow" style="color: #00c721 !important;">Запись на онлайн-тренинг</a>
                                        </dd>
									</dl>
								</div>
								<div class="col-xxs-12 col-xs-6 col-sm-3">
